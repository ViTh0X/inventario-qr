"""
Django settings for prj_inventarioQR project.
...
SECRET_KEY = 'django-insecure-v+d71rxb0#*4k%bpzbhfe3#_tdurh0^*jv=d0tamr9*@b#dk2j'

# SECURITY WARNING: don't run with debug turned on in production!
#if bool(os.getenv('ALLOWED_HOSTS')):
#    host = False
#else:
    #host = True
host = bool(os.getenv('ALLOWED_HOSTS'))
print(host)
DEBUG = host
...
ROOT_URLCONF = 'prj_inventarioQR.urls'
...
WSGI_APPLICATION = 'prj_inventarioQR.wsgi.application'
